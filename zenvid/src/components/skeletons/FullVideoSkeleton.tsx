...
// xs:w-[100vw]  md:w-[80vw] lg:w-[90vw] xl:w-[73vw] lg:h-[90vh] xs:h-[200px]
export default function VideoFullSkeleton() {
  return (
    <div className='flex w-full gap-2 xl:w-[73vw] '>
    <div className="flex flex-col  animate-pulse  h-full justify-center flex-grow flex-shrink ">
       <div className=" aspect-[16/9] w-full xl:min-w-[73vw]    bg-gray-300 dark:bg-gray-700  rounded-lg mb-1 ">
              </div>
