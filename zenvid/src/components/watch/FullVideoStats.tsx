...
export default function FullVideoStats({stats, createdAt, videId, tips, likes} : statsProps) {
  ...
  return (
    <div className={`flex justify-between items-center px-1 border-b border-b-gray-400/60 dark:border-gray-800 pb-2 my-3 `}>
...
<p className='xs:text-xs'>{duration.humanize().replace("a", "")} ago</p>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
   ...
   <p className='text-xs'>{stats?.viewCount} views</p>
         </div>
         </div>

         <div className='flex gap-6 items-center justify-center'>
          <div className='flex items-center gap-2 hover:text-rose-500 cursor-pointer'>
...
<p className='text-sm md:font-semibold'>Support</p>
          ...
          <div className=' items-center gap-2 hover:text-rose-500 cursor-pointer  hidden md:flex'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
