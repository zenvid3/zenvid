...
const SensitiveWarning: FC<Props> = ({ acceptWarning }) => {
  return (
    <div className='dark:bg-background-lightest flex aspect-[16/9] h-full w-full items-center justify-center space-x-5 rounded-xl bg-gray-100 p-10 text-lg dark:text-white'>
